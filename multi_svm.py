...
multi_rf.py
~~~~~~~~~~~~~~~~~~~~~
This script uses SVM to do the multi-categorize task.
...
# train the model
clf = SVC(kernel='rbf', C=5.0, gamma='auto', probability=True, decision_function_shape='ovr')
...
plt.legend()
plt.savefig(pic_path + 'multi_svm_roc_curve.png')
...
plt.legend()
plt.savefig(pic_path + 'multi_svm_pr_curve.png')
